...
void main() {
  test('parses full object', () async {
    final parsed = TransactionReceipt.fromMap(json.decode(
        ...
        '"blockNumber":"0x18","contractAddress":"0x6671e02bb8bd3a234b13d79d1c285a9df657233d",'
        '"cumulativeGasUsed":"0x4cc5f","from":"0xf8c59caf9bb8a7a2991160b592ac123108d88f7b",'
        '"gasUsed":"0x4cc5f","logs":[{"logIndex":"0x1","blockNumber":"0x1b4",'
        '"blockHash":"0x8216c5785ac562ff41e2dcfdf5785ac562ff41e2dcfdf829c5a142f1fccd7d",'
        '"transactionHash":"0xdf829c5a142f1fccd7d8216c5785ac562ff41e2dcfdf5785ac562ff41e2dcf",'
        '"transactionIndex":"0x0","address":"0x16c5785ac562ff41e2dcfdf829c5a142f1fccd7d",'
        ...
        '"transactionIndex":"0x18","status":"0x1"}') as Map<String, dynamic>);
    expect(
        parsed,
        TransactionReceipt(
  ...
  test('parses incomplete object', () async {
    final parsed = TransactionReceipt.fromMap(json.decode(
        ...
        '"blockHash":"0x5548b5f215b99674c7f23c9a701a005b5c18e4a963b55163eddada54562ac521",'
        '"cumulativeGasUsed":"0x4cc5f"}') as Map<String, dynamic>);
    expect(
        parsed,
        TransactionReceipt(
          transactionHash: hexToBytes(
