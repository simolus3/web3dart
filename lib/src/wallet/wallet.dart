...
class Wallet {
  ...
  const Wallet._(
      this.credentials, this._derivator, this._password, this._iv, this._id);
  ...
  String toJson() {
    ...
    final map = {
      'crypto': {
        'cipher': 'aes-128-ctr',
        'cipherparams': {'iv': numbers.bytesToHex(_iv)},
  ...
  static Wallet createNew(
      Credentials credentials, String password, Random random,
      {int scryptN = 8192}) {
  ...
  static Wallet fromJson(String encoded, String password) {
    ...
    */
    ...
    final credentials =
        Credentials.fromPrivateKey(numbers.bytesToInt(privateKey));

    // Obtain the uuid of this wallet
    final id = uuidParser.parse(data['id'] as String);
  ...
  static String _generateMac(List<int> dk, List<int> ciphertext) {
    ...
    return numbers.bytesToHex(crypto.sha3(Uint8List.fromList(macBody)));
  }
